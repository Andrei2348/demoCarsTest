  ...
  <div class="aside__wrapper">
    ...
    <ul class="aside__menu-items">
      <li class="aside__menu-item">
        <router-link  to="/profile" class="aside__menu-item--link">
          <svg
            width="24"
            height="25"
            viewBox="0 0 24 25"
      ...
      <li class="aside__menu-item">
        <router-link  to="/" class="aside__menu-item--link">
          <svg
            width="24"
            height="25"
            viewBox="0 0 24 25"
      ...
      <li class="aside__menu-item">
        <router-link to="/settings" class="aside__menu-item--link">
          <svg
            width="24"
            height="25"
            viewBox="0 0 24 25"
